...
@app.route('/templates/novo_pedido.html', methods=['GET', 'POST'])
def novo_pedido():
...
@app.route('/templates/filtro_data.html', methods=['GET', 'POST'])
def filtro_data():
    if request.method == 'POST':
...
@app.route('/templates/pedido_info.html/<int:pedido_id>', methods=['GET', 'POST'])
